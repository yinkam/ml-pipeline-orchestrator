...
class Pipeline(TimestampMixin, Base):
    ...
    workflow: Mapped[dict] = mapped_column(Text, nullable=True) # Store the workflow dictionary as JSON
    step_configs: Mapped[dict] = mapped_column(Text, nullable=True) # Store step configurations as JSON
